...
CSV_FOLDER  = os.path.join(_PROJECT_ROOT, "data", "raw", "active", "csv")
META_FOLDER = os.path.join(_PROJECT_ROOT, "data", "raw", "active", "meta")
LABELS_FOLDER = os.path.join(_PROJECT_ROOT, "data", "raw", "active", "labels")
OUT_FOLDER  = os.path.join(_PROJECT_ROOT, "data", "processed", "shared")
XGB_OUT_DIR = os.path.join(_PROJECT_ROOT, "data", "processed", "xgboost")
CNN_OUT_DIR = os.path.join(_PROJECT_ROOT, "data", "processed", "cnn_1d")
