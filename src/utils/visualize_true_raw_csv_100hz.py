...
def main():
    ...
    filenames = ["true_raw_sensor_100hz_pothole.png", "true_raw_sensor_100hz_speedbump.png", "true_raw_sensor_100hz_nonevent.png"]
    ...
    for ev, title, filename in zip(events, titles, filenames):
        ...
        out_dir = os.path.join("evaluation", "reports", "waveforms", "resampled_100hz")
