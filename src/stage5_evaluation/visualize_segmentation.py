...
def main():
    # Load data
    try:
        X_path = os.path.join(BASE_DIR, 'data', 'processed', 'cnn_1d', 'cnn_1d_X.npy')
        y_path = os.path.join(BASE_DIR, 'data', 'processed', 'cnn_1d', 'cnn_1d_y.npy')
        X = np.load(X_path)
    ...
    out_path = os.path.join(BASE_DIR, 'evaluation', 'event_centered_segmentation.png')
