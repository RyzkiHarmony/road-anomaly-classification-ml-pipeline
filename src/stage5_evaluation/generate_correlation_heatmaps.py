...
def generate_heatmaps():
    out_dir = os.path.join(BASE_DIR, "evaluation", "reports")
    os.makedirs(out_dir, exist_ok=True)
    
    # -------------------------------------------------------------
    # 1. XGBoost All Engineered Features Correlation Heatmap
    # -------------------------------------------------------------
    xgb_path = os.path.join(BASE_DIR, "data", "processed", "xgboost", "xgboost_labeled_windows.csv")
    ...
    # -------------------------------------------------------------
    cnn_path = os.path.join(BASE_DIR, "data", "processed", "cnn_1d", "cnn_1d_X.npy")
