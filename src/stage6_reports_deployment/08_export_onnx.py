...
sys.path.append(os.path.join(_PROJECT_ROOT, "src", "stage4_modeling", "cnn"))

from architecture import InceptionTime1D
...
def main():
    ...
    best_params_path = os.path.join(_PROJECT_ROOT, "src", "stage4_modeling", "cnn", "best_optuna_params.json")
