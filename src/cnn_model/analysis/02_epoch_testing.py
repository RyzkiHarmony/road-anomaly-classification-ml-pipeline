...
LR         = 0.001  # Fixed — same as train_cnn.py
BATCH_SIZE = 32     # Fixed — same as train_cnn.py
...
def main():
    ...
    print(f"Device: {device} | Epoch search: {EPOCHS_LIST}")
    ...
    for epochs in EPOCHS_LIST:
        ...
        print(f"-> Epochs={epochs} | Train F1={run_res['train_pothole_f1']:.4f} "
