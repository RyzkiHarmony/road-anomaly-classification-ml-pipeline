...
def main():
    ...
    # ─── ONNX EXPORT ───
    logger.info("ONNX export is now handled exclusively by 007_export_onnx.py to ensure MobileInferenceWrapper is applied.")
    logger.info("Please run `python src/cnn_model/007_export_onnx.py` manually after training.")
